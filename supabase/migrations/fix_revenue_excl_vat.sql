...
SELECT
    ...
    SUM(COALESCE(total_before_tax, grand_total - COALESCE(total_tax, 0))) as total_revenue,
    ROUND(AVG(COALESCE(total_before_tax, grand_total - COALESCE(total_tax, 0)))::numeric, 2) as avg_order_value,
...
SELECT
    ...
    status,
    COUNT(*) as order_count,
    SUM(COALESCE(total_before_tax, grand_total - COALESCE(total_tax, 0))) as total_value,
    currency
FROM orders
...
SELECT
    ...
    o.id as order_id,
    o.order_number,
    COALESCE(o.total_before_tax, o.grand_total - COALESCE(o.total_tax, 0)) as order_total,
