...
export function getStoreIdForTable(tableName, storeId, shopId) {
  const shopIdTables = ['ga4_ecommerce', 'shops', 'weekly_analyses', 'action_recommendations', 'chat_sessions', 'merchant_goals', 'context_notes', 'growth_engine_snapshots', 'support_tickets', 'support_daily_stats', 'paste_products', 'paste_snapshots', 'paste_orders']
